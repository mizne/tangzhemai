 ...
 */
@Component({
  selector: 'page-order-statistics',
  templateUrl: 'order-statistics.html',
  providers: [DestroyService]
})
export class OrderStatisticsPage implements OnInit {
  ...
  ionViewDidEnter(): void {
    this.store.dispatch(new FetchOrdersStatisticsOfTodayAction())
    this.store.dispatch(new FetchOrdersStatisticsOfThisMonthAction())
    this.store.dispatch(new FetchOrdersStatisticsOfThisYearAction())
  }
  ...
  private initOrderStatistics(): void {
